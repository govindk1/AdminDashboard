...
// export default Collegestatewisedetails
    ...
    <TableContainer component={Paper}>
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell>Course Wise College Percentage</TableCell>
